...
namespace MyWeb.Controllers
{
    ...
    [ApiController]
    public class ChiTietHoaDonBanController : ApiCoreController
    {
        private readonly IChiTietHoaDonBanService _service;

        public ChiTietHoaDonBanController(IChiTietHoaDonBanService service)
        {
            _service = service;
        }
        ...
        public async Task<ApiResponse> Add([FromBody] ChiTietHoaDonBan item)
        {
            try
            {
        ...
        [ProducesResponseType((int)HttpStatusCode.BadRequest)]
        [Consumes("application/json")]
        public async Task<ApiResponse> Updated(ChiTietHoaDonBan item)
        {
            try
            {
                await Task.Delay(0);
